;
/****** Object:  Table `Albums`    Script Date: 10/5/2016 10:48:52 AM ******/
...
CREATE TABLE `Albums`(
	...
	`AmazonUrl` varchar(max) NULL,
	`SpotifyUrl` varchar(max) NULL,
 CONSTRAINT `PK_dbo.Albums` PRIMARY KEY 
(
	`Id` ASC
)
)
...
;
/****** Object:  Table `Artists`    Script Date: 10/5/2016 10:48:52 AM ******/
...
CREATE TABLE `Artists`(
	...
	`AmazonUrl` varchar(256) NULL,
 CONSTRAINT `PK_dbo.Artists` PRIMARY KEY 
(
	`Id` ASC
)
)
...
;
/****** Object:  Table `Tracks`    Script Date: 10/5/2016 10:48:52 AM ******/


CREATE TABLE `Tracks`(
	`Id` int AUTO_INCREMENT NOT NULL,
	`AlbumId` int NULL,
	`SongName` varchar(128) NULL,
	`Length` varchar(10) NULL,
	`Bytes` int NOT NULL,
	`UnitPrice` decimal(18, 2) NOT NULL,
 CONSTRAINT `PK_dbo.Tracks` PRIMARY KEY 
(
	`Id` ASC
)
)
...
;
/****** Object:  Table `Users`    Script Date: 10/5/2016 10:48:52 AM ******/
...
Overall this album is a delightful mix of Metal and Punk Rock lore that ;t not nearly enough attention from fans or press.', 0, N'http://ecx.images-amazon.com/images/I/61CMcYAP%2BQL._SL500_AA280_.jpg', N'http://www.amazon.com/gp/product/B004MC5YEY/ref=as_li_ss_tl?ie=UTF8camp=1789creative=390957creativeASIN=B004MC5YEYlinkCode=as2tag=westwindtechn-20', N'')
;
INSERT `Albums` (`Id`, `ArtistId`, `Title`, `Description`, `Year`, `ImageUrl`, `AmazonUrl`, `SpotifyUrl`) VALUES (512, 328, N'Animosity', N'One of the best punk metal cross-over albums ever made and maybe *the* album that defined the genre.
...
ACCEPT had more money this time for a better produced album and 10 excellent Hardrockin''/Heavymetal tracks to ; with it . No rock ballads like their previous album 1980''s I''M A REBEL which i''ve also typed a review about all Great Heavy metal riffs on this album.', 1982, N'https://images-na.ssl-images-amazon.com/images/I/51fIOETov9L._SL250_.jpg', N'http://www.amazon.com/gp/product/B0007ZBG1U/ref=as_li_tl?ie=UTF8camp=1789creative=390957creativeASIN=B0007ZBG1UlinkCode=as2tag=westwindtechn-20linkId=ZPNI5HMO3ZTBZQJ3', N'https://play.spotify.com/album/70lhKu95Wy760ZAZeUaZje')
;
INSERT `Albums` (`Id`, `ArtistId`, `Title`, `Description`, `Year`, `ImageUrl`, `AmazonUrl`, `SpotifyUrl`) VALUES (1716, 352, N'Inside Your''s', N'Heavy yet Melodic, "Inside Yours" was as impressive and real as anything that was coming out of Seattle at the time.
...
;
INSERT `Artists` (`Id`, `ArtistName`, `Description`, `ImageUrl`, `AmazonUrl`) VALUES (8, N'Audioslave', N'When Zack de la Rocha left Rage Against the Machine in October 2000, the band''s future was put into question. Within months rumors flew that ex-Soundgarden frontman Chris Cornell would replace de la Rocha. And ;ssip fueled truth, for Cornell joined the rest of Rage in the studio in May 2001. The mix was great and a musical bond was in the making: Cornell, Tim Commerford, Brad Wilk, and Tom Morello spent the next year writing and recording. By spring 2002, the foursome were no longer ;ing by the Rage Against the Machine name and signed on for Ozzfest. But before the summer tour even ;t underway, Cornell quit the new project. 
...
;
INSERT `Artists` (`Id`, `ArtistName`, `Description`, `ImageUrl`, `AmazonUrl`) VALUES (330, N'Henry Rollins Band', N'Rollins Band was an American rock band led by singer and songwriter Henry Rollins.
...
The band have been cate;rized under the alternative metal, hard rock and post-hardcore genres.`8``9``10` They were part of the early 90s LA alternative metal scene, alongside bands such as Tool, Jane''s Addiction, Rage Against the Machine and Green Jellÿ.`10` Their influences include 70s metal and rock bands, such as Black Sabbath, The Velvet Underground, Pink Fairies and Thin Lizzy.`8` Rollins'' shout-singing style proved influential to later nu metal and alternative metal artists such as Coal Chamber, Korn, Chevelle, ;dsmack and System of a Down.`8` Rollins Band have been covered by Pearl Jam.`11`', N'http://upload.wikimedia.org/wikipedia/commons/a/a1/Henry_Rollins_2.jpg', N'')
;
INSERT `Artists` (`Id`, `ArtistName`, `Description`, `ImageUrl`, `AmazonUrl`) VALUES (331, N'Motörhead (Sql)', N'Motörhead have never JUST been the best rock''n''roll band in the world. They''ve never JUST been the loudest. Or the hardest. Or the toughest. Or the bad-ass-est. No...Motörhead are also a lifestyle.', N'http://news.sagacom.com/wp-content/blogs.dir/3/files/2015/11/philtaylor.jpg', N'http://www.amazon.com/gp/product/B00005NHO2/ref=as_li_ss_tl?ie=UTF8camp=1789creative=390957creativeASIN=B00005NHO2linkCode=as2tag=westwindtechn-20')
;
INSERT `Artists` (`Id`, `ArtistName`, `Description`, `ImageUrl`, `AmazonUrl`) VALUES (332, N'Neurosis', N'Neurosis is a post-metal band, based in Oakland, California. They formed in 1985 as a hardcore punk band, and their sound progressed towards a doom metal style that also included influences from dark ambient and industrial music as well as incorporating elements of folk music. Terrorizer Magazine described Neurosis as "arguably the most influential band of the past two decades."`1`', N'http://www.earsplitcompound.com/site/wp-content/uploads/2013/09/neurosis_angelaowens-9-e1378737031742.jpg', N'')
;
INSERT `Artists` (`Id`, `ArtistName`, `Description`, `ImageUrl`, `AmazonUrl`) VALUES (333, N'Prong', N'', N'', N'')
;
INSERT `Artists` (`Id`, `ArtistName`, `Description`, `ImageUrl`, `AmazonUrl`) VALUES (334, N'Soundgarden', N'Soundgarden is an American rock band formed in Seattle, Washington, in 1984 by singer and rhythm guitarist Chris Cornell, lead guitarist Kim Thayil, and bassist Hiro Yamamoto. Matt Cameron became the band''s full-time drummer in 1986, while bassist Ben Shepherd became a permanent replacement for Yamamoto in 1990.

Soundgarden was one of the seminal bands in the creation of grunge, a style of alternative rock that developed in Seattle, and was one of a number of grunge bands signed to the record label Sub Pop. Soundgarden was the first grunge band to sign to a major label (AM Records, in 1988), though the band did not achieve commercial success until they popularized the genre in the early 1990s with Seattle contemporaries Pearl Jam, Nirvana, and Alice in Chains.
...
;
INSERT `Artists` (`Id`, `ArtistName`, `Description`, `ImageUrl`, `AmazonUrl`) VALUES (349, N'Exodus', N'nce the kings of the Bay Area metal scene -- the birthplace of thrash -- Exodus were unceremoniously demoted from their post with the arrival of Los Angeles'' Metallica in 1982. And while they proceeded to eke out a hit-and-miss career of their own over the next few decades, all the while influencing at least two separate generations of younger thrash bands, Exodus were ultimately fated to be the ultimate also-rans of the genre they helped spawn.
...
In 1984, Chris Tense returned to the band, this time on bass, replacing Glen Estes (later of Portland, Ore;n punk/metal band Final Warning), and the group released the Record Collectors Are Pretentious Assholes 12” (the cover features Pig Champion’s substantial vinyl collection). The record found the band incorporating subtle rock elements into their music, which was further honed on their contributions to two 1985 compilations, “Laughing Boy” on the Drinking is Great EP (on which appeared other Ore;n punk bands Final Warning, Lockjaw and E-13), and “Typical” and “Die on Your Knees” on the legendary Cleanse the Bacteria LP (compiled by Pushead for his own Pusmort label).
...
;
INSERT `Artists` (`Id`, `ArtistName`, `Description`, `ImageUrl`, `AmazonUrl`) VALUES (357, N'Discharge', N'Discharge are a British hardcore punk band formed in 1977 by Terence "Tezz" Roberts and Royston "Rainy" Wainwright. While the band had substantial line-up changes over its history, the classic line-up from the early 1980s featured bassist Wainwright, drummer Roberts, his brother Anthony "Bones" Roberts playing guitar, and vocalist Kelvin "Cal" Morris.`1`
...
;
INSERT `Artists` (`Id`, `ArtistName`, `Description`, `ImageUrl`, `AmazonUrl`) VALUES (362, N'Attitude Adjustment', N'Attitude Adjustment is a crossover thrash band originally formed in the early 1980s in the San Francisco Bay Area.
...
;
INSERT `Artists` (`Id`, `ArtistName`, `Description`, `ImageUrl`, `AmazonUrl`) VALUES (598, N'Van Halen', N'LA Rock Legends of the third kind!', NULL, N'')
;
INSERT `Artists` (`Id`, `ArtistName`, `Description`, `ImageUrl`, `AmazonUrl`) VALUES (599, N'Scorpions', N'The Scorprions are ;od old fashioned German Hard Rock from the 80s and beyond.', NULL, N'')
;
INSERT `Artists` (`Id`, `ArtistName`, `Description`, `ImageUrl`, `AmazonUrl`) VALUES (631, N'Merciful Fate', N'Arguably the most original and critically acclaimed group to come from Denmark was Mercyful Fate. Mercyful Fate''s nucleus comprised of the multi-octave vocals of King Diamond aka Kim Bendix Petersen, and the twin lead guitar attack of Hank Sherman aka Rene Krolmark and Michael Denner. ''Melissa'' was the group''s first formal recording and was a featured LP for Road Runner Records. Although ''Melissa'' was originally released in 1983, and re-released in 1997, Roadrunner Records has remastered the songs and released this classic for your listening enjoyment. It includes the highly sought after early 1980''s BBC sessions, two extra demo tracks of ''Black Funeral'', and ''Curse of the Pharaohs'' and a three track DVD featuring live footage of the band during early 1983. A commentary by King Diamond himself narrates the performance and the story of the group during that time frame. Mercyful Fate pioneered a sub genre of ultra heavy and complex music renown for its macabre lyrics, and Satanic/occultism driven imagery and attitude called Black Metal.', N'http://www.metalinjection.net/wp-content/uploads/2014/07/mercyful-fate_photo03.jpg', N'http://www.amazon.com/gp/product/B0011ZVVJ2/ref=as_li_tl?ie=UTF8camp=1789creative=390957creativeASIN=B0011ZVVJ2linkCode=as2tag=westwindtechn-20linkId=VAIRVQFRSELFJ7V2')
;
INSERT `Artists` (`Id`, `ArtistName`, `Description`, `ImageUrl`, `AmazonUrl`) VALUES (632, N'Death Angel', N'Death Angel is a thrash metal band from Concord, California, initially active from 1982 to 1991 and again since 2001. Death Angel has released seven studio albums, two demo tapes, one box set and two live albums.
...
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1, 1, N'For Those About To Rock (We Salute You)', N'5:03', 11170334, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (2, 2, N'Balls to the Wall', N'5:02', 5510424, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3, 3, N'Fast As a Shark', N'3:10', 3990994, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4, 3, N'Restless and Wild', N'4:12', 4331779, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (6, 1, N'Put The Finger On You', N'3:05', 6713451, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7, 1, N'Let''s Get It Up', N'3:13', 7636561, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8, 1, N'Inject The Venom', N'3:10', 6852860, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (9, 1, N'Snowballed', N'3:03', 6599424, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (10, 1, N'Evil Walks', N'4:03', 8611245, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (11, 1, N'C.O.D.', N'3:19', 6566314, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (12, 1, N'Breaking The Rules', N'4:03', 8596840, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (13, 1, N'Night Of The Long Knives', N'3:05', 6706347, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (14, 1, N'Spellbound', N'4:10', 8817038, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (15, 4, N'; Down', N'5:11', 10847611, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (16, 4, N'Dog Eat Dog', N'3:15', 7032162, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (17, 4, N'Let There Be Rock', N'6:06', 12021261, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (18, 4, N'Bad Boy Boogie', N'4:07', 8776140, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (19, 4, N'Problem Child', N'5:05', 10617116, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (20, 4, N'Overdose', N'6:09', 12066294, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (21, 4, N'Hell Ain''t A Bad Place To Be', N'4:14', 8331286, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (22, 4, N'Whole Lotta Rosie', N'5:03', 10547154, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (23, 5, N'Heavy Metal Thunder', N'4:27', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (24, 5, N'To and back again', N'4:57', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (25, 5, N'Strong Arm of the Law', N'4:54', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (26, 5, N'Taking your Chances', N'4:26', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (27, 5, N'20,000 Feet', N'3:30', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (28, 6, N'Motorcyle Man', N'3:58', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (29, 6, N'Wheels of Steel', N'5:58', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (30, 6, N'Machine Gun', N'5:23', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (31, 6, N'Freeway Mad', N'2:41', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (32, 8, N'Smokin'' Valves', N'3:41', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (33, 8, N'Death or Glory', N'3:36', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (34, 8, N'Heavy Metal Mania', N'4:50', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (35, 8, N'The Nightcomers', N'6:13', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (36, 8, N'The Small Hours', N'5:12', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (37, 9, N'Homeless Crew', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (38, 9, N'To Whom it may Concern', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (39, 9, N'Kicked in the Teeth', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (40, 9, N'Practicing for War', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (41, 9, N'No TV Sketch', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (42, 9, N'Save Thy Brother', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (43, 9, N'Warhead', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (44, 9, N'When Worlds Collide', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (45, 9, N'Third World Child', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (46, 12, N'Antisocial', N'5:09', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (47, 12, N'Monsieur Comedie', N'3:25', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (48, 12, N'Instinct de Mort', N'3:46', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (49, 12, N'Au No De La Race', N'3:24', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (50, 12, N'Passe', N'3:43', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (51, 7, N'We Die Young', N'2:12', 4925362, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (52, 7, N'Man In The Box', N'4:06', 9310272, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (53, 7, N'Sea Of Sorrow', N'5:09', 11316328, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (54, 7, N'Bleed The Freak', N'4:01', 7847716, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (55, 7, N'I Can''t Remember', N'3:02', 7302550, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (56, 7, N'Love, Hate, Love', N'6:07', 12575396, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (57, 7, N'It Ain''t Like That', N'4:17', 8993793, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (58, 7, N'Sunshine', N'4:04', 9216057, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (59, 7, N'Put You Down', N'3:16', 6420530, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (60, 7, N'Confusion', N'5:04', 11183647, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (61, 7, N'I Know Somethin (Bout You)', N'4:01', 8497788, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (62, 7, N'Real Thing', N'4:03', 7937731, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (63, 13, N'Préfabriqués', N'2:59', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (64, 13, N'Palace', N'5:26', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (65, 13, N'Police Milice', N'2:24', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (66, 13, N'Ride On', N'6:45', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (85, 10, N'Cochise', N'3:02', 5339931, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (86, 10, N'Show Me How to Live', N'4:17', 6672176, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (87, 10, N'Gasoline', N'4:19', 6709793, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (88, 10, N'What You Are', N'4:09', 5988186, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (89, 10, N'Like a Stone', N'4:14', 7059624, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (90, 10, N'Set It Off', N'4:03', 6321091, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (91, 10, N'Shadow on the Sun', N'5:03', 8245793, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (92, 10, N'I am the Highway', N'5:14', 8041411, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (93, 10, N'Exploder', N'3:06', 4948095, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (94, 10, N'Hypnotize', N'3:06', 4961887, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (95, 10, N'Bring''em Back Alive', N'5:09', 7911634, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (96, 10, N'Light My Way', N'5:03', 7289084, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (97, 10, N'Getaway Car', N'4:19', 7193162, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (98, 10, N'The Last Remaining Light', N'5:17', 7622615, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (99, 11, N'Your Time Has Come', N'4:15', 8273592, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (100, 11, N'Out Of Exile', N'4:11', 9506571, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (101, 11, N'Be Yourself', N'4:19', 9106160, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (102, 11, N'Doesn''t Remind Me', N'4:15', 8357387, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (103, 11, N'Drown Me Slowly', N'3:13', 7609178, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (104, 11, N'Heaven''s Dead', N'4:16', 9006158, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (105, 11, N'The Worm', N'3:17', 7710800, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (106, 11, N'Man Or Animal', N'3:13', 7542942, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (107, 11, N'Yesterday To Tomorrow', N'4:13', 8944205, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (108, 11, N'Dandelion', N'4:18', 9003592, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (109, 11, N'#1 Zero', N'4:19', 9731988, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (110, 11, N'The Curse', N'5:09', 10029406, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (408, 35, N'Free Speech For The Dumb', N'2:15', 5076048, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (409, 35, N'It''s Electric', N'3:13', 6978601, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (410, 35, N'Sabbra Cadabra', N'6:00', 12418147, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (411, 35, N'Turn The Page', N'6:06', 11946327, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (412, 35, N'Die Die My Darling', N'2:09', 4867667, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (413, 35, N'Loverman', N'7:12', 15446975, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (414, 35, N'Mercyful Fate', N'11:11', 21942829, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (415, 35, N'Astronomy', N'6:17', 13065612, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (416, 35, N'Whiskey In The Jar', N'5:05', 9943129, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (417, 35, N'Tuesday''s ;ne', N'9:05', 17900787, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (418, 35, N'The More I See', N'4:07', 9378873, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1829, 150, N'Hit The Lights', N'4:17', 8357088, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1830, 150, N'The Four Horsemen', N'7:13', 14178138, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1831, 150, N'Motorbreath', N'3:08', 6153933, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1832, 150, N'Jump In The Fire', N'4:01', 9135755, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1833, 150, N'(Anesthesia) Pulling Teeth', N'4:14', 8234710, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1834, 150, N'Whiplash', N'4:09', 8102839, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1835, 150, N'Phantom Lord', N'5:02', 9817143, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1836, 150, N'No Remorse', N'6:06', 12672166, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1837, 150, N'Seek  Destroy', N'6:15', 13452301, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1838, 150, N'Metal Militia', N'5:11', 10141785, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1874, 154, N'Fight Fire With Fire', N'4:05', 9420856, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1875, 154, N'Ride The Lightning', N'6:17', 13055884, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1876, 154, N'For Whom The Bell Tolls', N'5:11', 10159725, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1877, 154, N'Fade To Black', N'6:14', 13531954, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1878, 154, N'Trapped Under Ice', N'4:04', 7975942, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1879, 154, N'Escape', N'4:04', 8652332, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1880, 154, N'Creeping Death', N'6:16', 12955593, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (1881, 154, N'The Call Of Ktulu', N'8:14', 17486240, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3389, 271, N'Revelations', N'4:12', 4111051, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3390, 271, N'One and the Same', N'3:17', 3559040, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3391, 271, N'Sound of a Gun', N'4:00', 4234990, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3392, 271, N'Until We Fall', N'3:10', 3766605, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3393, 271, N'Original Fire', N'3:18', 3577821, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3394, 271, N'Broken City', N'3:08', 3728955, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3395, 271, N'Somedays', N'3:13', 3497176, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3396, 271, N'Shape of Things to Come', N'4:14', 4465399, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3397, 271, N'Jewel of the Summertime', N'3:13', 3806103, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3398, 271, N'Wide Awake', N'4:06', 4333050, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3399, 271, N'Nothing Left to Say But ;odbye', N'3:13', 3484335, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3400, 271, N'Moth', N'4:18', 4838884, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3401, 271, N'Show Me How to Live (Live at the Quart Festival)', N'5:01', 4901540, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (3402, 271, N'Band Members Discuss Tracks from "Revelations"', N'4:14', 61118891, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4946, 618, N'Dirty Deeds Done Dirt Cheap', N'4:11', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4947, 618, N'Love at First Feel', N'3:10', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4948, 618, N'Big Balls', N'2:38', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4949, 618, N'Rocker', N'2:49', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4950, 618, N'Problem Child', N'5:44', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4951, 618, N'There''s ;ing to be some Rocking', N'3:17', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4952, 618, N'Ain''t no fun (waiting around to be a millionaire', N'7:29', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4953, 618, N'Ride on', N'5:49', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4954, 618, N'Squealer', N'5:14', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4955, 511, N'Big Time Game Hunting', N'2:40', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4956, 511, N'Aggressive System', N'1:22', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4957, 511, N'Thoughts of Equality', N'3:57', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4958, 511, N'Practicing for War', N'1:45', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4959, 511, N'Crutch', N'0:37', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4960, 511, N'Anti-Social', N'2:35', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4961, 511, N'Cavern in Time', N'2:56', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4962, 511, N'Crucified System', N'3:05', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4963, 511, N'Emotional Blur', N'3:25', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4964, 511, N'Cleansing Pool', N'2:26', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4965, 511, N'Ocean', N'1:25', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4966, 511, N'Save Thy Brother', N'2:57', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4967, 511, N'D-Day', N'0:46', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (4968, 511, N'When Worlds Collide', N'3:16', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5075, 521, N'CID', N'2:47', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5076, 521, N'I couldn''t be you', N'3:21', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5077, 521, N'I live in a car', N'2:37', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5078, 521, N'Tomorrows Girls', N'3:35', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5079, 521, N'Kicks', N'4:57', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5080, 521, N'Left for Dead', N'4:57', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5081, 521, N'Rat Race', N'5:18', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5082, 521, N'War Head', N'4:06', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5083, 521, N'New York State Police', N'5:47', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5084, 521, N'Telephone Numbers', N'4:17', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5085, 521, N'Public Servant', N'1:38', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5086, 521, N'Rockers', N'2:45', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5087, 521, N'Public Servant', N'1:31', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5088, 521, N'Crash Course', N'2:43', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5089, 521, N'Emotional Blackmail', N'3:35', 0, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5090, 2, N'Fight it back', N'3:57', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5091, 2, N'London Leatherboys', N'3:12', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5093, 2, N'Head over Heels', N'3:44', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5094, 2, N'Losing more than you''ve ever had', N'4:22', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5095, 2, N'Love Child', N'5:12', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5096, 582, N'Du lebst nur einmal', N'2:09', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5097, 584, N'Believe', N'3:46', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5098, 584, N'This is not the end', N'3:59', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5099, 584, N'Time won''t let me ;', N'4:11', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5100, 584, N'Above and below', N'3:30', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5101, 587, N'Bomb Track', N'4:03', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5102, 587, N'Killing in the Name', N'5:13', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5103, 587, N'Take the Power Back', N'5:36', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5104, 587, N'Settle for Nothing', N'4:47', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5105, 587, N'Bullet in the Head', N'5:07', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5106, 587, N'Know your Enemy', N'4:54', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5112, 590, N'Ninja', N'4:31', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5113, 590, N'Kill the Power', N'4:35', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5114, 590, N'Ruling Force', N'3:52', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5115, 591, N'Hard Ride', N'4:10', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5116, 591, N'Hell Patrol', N'3:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5117, 591, N'Don''t need your Money', N'3:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5118, 591, N'Rock into the Future', N'3:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5119, 4, N'Blue Eyed Sleeker', N'3:12', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5120, 592, N'City Boys', N'3:20', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5121, 592, N'Industry', N'4:01', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5122, 592, N'Love/Hate', N'3:01', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5123, 592, N'Hard Times', N'2:45', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5124, 592, N'Broken Hearts', N'3:45', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5125, 592, N'Folson Prison Blues', N'3:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5126, 592, N'Desperado', N'3:32', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5127, 593, N'Bonded By Blood', N'3:12', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5128, 593, N'Exodus', N'4:10', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5129, 593, N'Then there were none', N'4:22', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5130, 593, N'A Lesson in Violence', N'3:45', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5131, 595, N'Punk''s Not Dead', N'1:53', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5132, 595, N'Mucky Pup', N'1:45', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5133, 595, N'Cop Cars', N'1:55', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5134, 595, N'Free Flight', N'3:36', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5135, 595, N'Sex  Violence', N'5:11', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5136, 596, N'The Ides of March', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5137, 596, N'WrathChild', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5138, 596, N'Murder in the Rue Morgue', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5139, 596, N'Another Life', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5140, 596, N'Killers', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5141, 597, N'Tribe', N'4:21', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5142, 597, N'Machine Action', N'5:40', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5143, 597, N'Racked', N'4:10', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5144, 597, N'Crazy Love', N'4:54', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5145, 597, N'Above me', N'4:59', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5156, 597, N';tta Believe', N'4:01', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5157, 598, N'Running with the Devil', N'3:37', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5158, 598, N'Eruption', N'1:42', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5159, 598, N'You really ;t Me', N'2:37', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5160, 598, N'Ain''t talking about Love', N'3:49', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5161, 599, N'Blackout', N'3:48', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5162, 600, N'Thumb', N'4:41', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5163, 600, N'Green Machine', N'3:38', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5164, 601, N'Broken Lungs', N'4:14', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5165, 601, N'The Sky is falling', N'4:21', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5166, 601, N'Moving Mountains', N'2:55', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5167, 603, N'Plastic Bomb', N'3:07', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5168, 603, N'Deep Sleep', N'2:23', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5169, 604, N'Warning', N'2:49', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5170, 604, N'Never Again', N'2:20', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5171, 604, N'Hear Nothing, See Nothing, Say Nothing', N'1:29', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5172, 604, N'Where there''s a Will', N'2:05', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5173, 604, N'The Price of Silence', N'2:20', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5174, 604, N'Born to Die in the Gutter', N'2:27', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5175, 605, N'Time Bomb', N'2:26', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5176, 605, N'Sick Boy', N'2:32', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5177, 605, N'City Baby Attacked by Rats', N'2:34', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5178, 607, N'Battery', N'5:10', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5179, 607, N'Master of Puppets', N'8:38', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5180, 607, N'The thing that should not be', N'6:32', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5186, 609, N'Rapid Fire', N'4:08', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5187, 609, N'Breaking the Law', N'3:58', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5188, 609, N'Grinder', N'3:57', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5189, 610, N'Exciter', N'5:32', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5190, 610, N'Running Wild', N'2:49', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5191, 610, N'Sinner', N'7:29', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5192, 610, N'The Ripper', N'2:34', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5193, 610, N'The Green Manilishi', N'3:12', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5194, 611, N'The Grudge', N'8:36', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5195, 611, N'Eo Blue Apocalypse', N'1:04', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5196, 611, N'The Patient', N'7:13', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5197, 611, N'Schism', N'6:47', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5198, 611, N'Parabol', N'3:04', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5199, 612, N'Tanz Debil', N'3:23', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5200, 612, N'Steh auf Berlin', N'3:47', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5201, 612, N'Negativ Nein', N'2:27', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5202, 612, N'U-Haft Musik', N'3:41', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5203, 613, N'Heaven''s not overflowing', N'5:02', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5204, 613, N'Albatross', N'5:20', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5205, 613, N'Clean my Wounds', N'3:32', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5206, 613, N'Deliverance', N'4:23', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5208, 615, N'Stay Clean', N'2:50', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5209, 615, N'Metropolis', N'3:31', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5210, 615, N'The Hammer', N'3:05', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5211, 615, N'Iron Horse', N'3:58', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5212, 615, N'No Class', N'2:34', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5213, 615, N'Overkill', N'5:13', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5214, 616, N'Grey World', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5215, 616, N'Bombs', N'0:0)', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5216, 616, N'Hunger and Poverty', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5217, 616, N'Fuck Chuck', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5218, 616, N'Dead Serious', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5219, 616, N'American Paranoia', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5220, 617, N'Strom', N'2:45', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5221, 617, N'Immer Alles Neu', N'2:57', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5222, 617, N'Auflösen', N'3:19', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5223, 617, N'Teil von Mir', N'3:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5224, 516, N'Ace of Spades (Sql)', N'2:49', 0, CAST(1.29 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5225, 516, N'Love me like a Reptile', N'2:23', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5226, 516, N'Shoot you in back', N'2:39', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5227, 516, N'We are the Road Crew', N'3:12', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5228, 516, N'The Chase is better than the Catch', N'4:18', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5229, 512, N'Loss for Words', N'4:03', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5230, 512, N'Mad World', N'1:53', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5231, 512, N'Consumed', N'2:52', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5232, 512, N'Holier', N'2:25', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5233, 512, N'Positive Outlook', N'3:01', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5234, 514, N'Low Self Opinion', N'5:24', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5235, 514, N'Grip', N'4:51', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5236, 514, N'Tearing', N'4:56', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5237, 514, N'You Didn''t Need', N'5:30', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5238, 514, N'Almost Real', N'8:05', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5239, 514, N'Obscene', N'8:46', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5240, 514, N'What do you do?', N'7:25', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5241, 514, N'Blues Jam', N'11:49', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5242, 515, N'Dicsonnect', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5243, 515, N'Fool', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5244, 515, N'Liar', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5245, 515, N'Alien Blueprint', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5246, 582, N'Was zaehlt', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5247, 582, N'Tier', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5248, 582, N'Kanzler Sein', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5249, 619, N'Kopf oder Zahl', N'2:46', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5250, 619, N'Ich bin die Sehnsucht', N'4:02', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5251, 619, N'Ich bin Sehnsucht in dir', N'4:02', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5252, 619, N'Weisses Rauschen', N'2:07', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (5260, 3, N'Princess of the Dawn', N'6:15', 6290521, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (6253, 592, N'Another Sad Story', N'3:23', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (6305, 655, N'Kicked in the Teeth', N'3:25', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (6306, 655, N'SummerTime Blues', N'3:48', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (6307, 655, N'Warhead', N'2:51', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (6308, 655, N'It''s no TV Sketch', N'01:32', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (6309, 655, N'Freak', N'3:14', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (6317, 659, N'Seemingly Endless Time', N'3:50', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (6318, 659, N'Stop', N'5:10', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (6319, 659, N'The Orgization', N'4:16', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (6320, 659, N'A Room with a View', N'4:41', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7423, 1644, N'Curse of the Pharaohs', N'3:10', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7424, 1644, N'Black Funeral', N'4:44', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7425, 1644, N'Into the Coven', N'3:42', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7426, 1704, N'You are (the ;vernment)', N'1:22', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7427, 1704, N'1000 More Fools', N'1:35', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7428, 1704, N'How much is enough?', N'1:22', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7429, 1704, N'When?', N'1:40', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7430, 1704, N'Give you nothing', N'2:02', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7431, 1704, N'Land of Competition', N'2:04', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7432, 1705, N'SuperSonic', N'1:46', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7433, 1705, N'Prove it', N'1:14', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7434, 1705, N'Can''t Stop It', N'1:09', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7441, 1707, N'Thrashers', N'7:11', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7442, 1707, N'Evil Priest', N'4.54', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7443, 1707, N'Voracious Souls', N'5:39', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7444, 1707, N'Kill as One', N'4:59', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7445, 1707, N'The Ultra-Violence', N'10:33', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7446, 1707, N'Mistress of Pain', N'4:04', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7447, 1708, N'Among the Living', N'5:16', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7448, 1708, N'Caught in a Mosh', N'5:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7449, 1708, N'I am the Law', N'5:54', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7450, 1708, N'Indians', N'5:41', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7451, 1708, N'One World', N'5:55', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7452, 1709, N'Potters Field', N'5:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7453, 1709, N'Only', N'4:56', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7454, 1709, N'Packaged Rebellion', N'6:16', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7455, 1709, N'Room for One More', N'4:55', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7460, 1710, N'Stinkfirstr', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7461, 1710, N'Eulogy', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7462, 1710, N'H.', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7463, 1710, N'Useful Idiot', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7464, 1710, N'Forty size and 2', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7465, 1712, N'Incomplete', N'2:29', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7466, 1712, N'Leave Mine to Me', N'2:07', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7467, 1712, N'Stranger to Fiction', N'2:20', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7468, 1712, N'Tiny Voices', N'2:37', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7469, 1711, N'To Crawl Under One''s Skin', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7470, 1711, N'Souls at Zero', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7471, 1711, N'Zero', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7472, 1711, N'Flight', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7473, 1711, N'Web', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7489, 1715, N'Run if you Can', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7490, 1715, N'Son of a Bitch', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7491, 1715, N'Starlight', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7492, 1715, N'Breaker', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7535, 616, N'9 to 5 Religion', N'0:00', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7536, 1716, N'Not a lot to Save', N'3:50', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7537, 1716, N'Crucifunkin''', N'4:32', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7538, 1716, N'Eyes of Stone', N'3:16', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7539, 1716, N'So Long', N'2:18', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7540, 1716, N'Buried', N'3:40', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7541, NULL, N'Jailbait', N'2:44', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7542, 1717, N'Iron Fist', N'2:55', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7543, 1717, N'Heart of Stone', N'3:04', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7544, 1717, N'I''m the doctor', N'2:43', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7545, 1718, N'Angelwitch', N'4:33', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7564, NULL, N'asdasd', N'12:12', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7565, NULL, N'Another song', N'2:43', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7566, NULL, N'More songs', N'2:22', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7567, 1719, N'Highway to Hell', N'3:33', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7568, 1719, N'Girls ;t Rythm', N'4:33', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7569, 1720, N'Rock n''Roll Damnation', N'3:37', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7570, 1720, N'Down Payment Blues', N'6:03', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7571, 1720, N'Gimme a Bullet', N'3:21', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7572, 1720, N'Riff Raff', N'5:11', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7573, 1720, N'Sin City', N'4:45', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7574, 1721, N'Back in the Saddle', N'3:12', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7575, 1721, N'Last Child', N'3:26', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7576, 1721, N'Rats in the Cellar', N'4:06', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7577, 1721, N'Combination', N'3:39', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7578, 1722, N'War Pigs', N'7:54', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7579, 1722, N'Paranoid', N'2:48', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7580, 1722, N'Planet Caravan', N'4:29', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7581, 1722, N'Iron Man', N'5:55', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7582, 1723, N'A Dangerous Meeting', N'5:10', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7583, 1723, N'Nightmare', N'6:19', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7584, 1723, N'Desecration of Souls', N'4:54', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7585, 1723, N'Night of the Unborn', N'4:59', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7586, 1724, N'Loving you Sunday Morning', N'5:38', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7587, 1724, N'Another Piece of Meat', N'3:31', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7588, 1724, N'Always somewhere', N'4:58', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7589, 1724, N'Coast to Coast', N'4:43', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7590, 1725, N'The Shrouded Temples', N'2:36', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7591, 1725, N'Damned for all Time', N'2:36', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7592, 1725, N'Dance of the Dead', N'4:29', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7593, 1725, N'Buried', N'5:16', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7594, 1726, N'Lifestyles', N'3:13', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7595, 1726, N'Short Fuse', N'1:59', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7596, 1726, N';d not ;d', N'0:52', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7597, 1726, N'Ugly American', N'2:59', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7598, 1726, N'Made to be Broken', N'2:54', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7599, NULL, N'Jailbait', N'3:12', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7600, 516, N'Jailbait', N'3:12', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (7605, NULL, N'Jailbait', N'4:21', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8605, 1727, N'State of the Union', N'2:19', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8606, 1727, N'The First Drop', N'2:39', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8607, 1727, N'Life Less Frightening', N'3:44', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8608, 1727, N'Paper Wings', N'3:43', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8609, 1727, N'Blood to Bleed', N'3:49', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8610, 1728, N'Alive and Well', N'2:06', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8611, 1728, N'My Life Inside of Your Heart', N'3:02', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8612, 1728, N'Great Awakening', N'1:35', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8613, 1728, N'Six ways ''Til Sunday', N'2:36', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8614, 1728, N'401kill', N'3:19', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8615, 1728, N'The Unraveling', N'3:12', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8622, 1729, N'Curse of the Pharaohs', N'3:10', 3990994, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8623, 3, N'New One', N'6:15', 6290521, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8624, 1730, N'Curse of the Pharaohs', N'3:10', 3990994, CAST(0.99 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8625, 1732, N'Anti-social', N'2:25', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8626, 1732, N'Misery', N'0:49', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8627, 1732, N'I am you', N'2:37', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8628, 1732, N'No Privacy', N'2:22', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8629, 1732, N'Lost', N'1:24', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8630, 1732, N'Sick Inside', N'1:44', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8631, 1732, N'Day By Day', N'3:08', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8632, 1732, N'Guilty As Charged', N'2:06', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8633, 1733, N'Saint Cecilia', N'3:41', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8634, 1733, N'Sean', N'2:11', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8635, 1733, N'Savior Breath', N'3:11', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8636, 1733, N'Iron Rooster', N'4:11', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8637, 1733, N'The NeverEnding Sigh', N'4:45', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8638, 1734, N'Bridge Burning', N'4:46', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8639, 1734, N'Rope', N'4:19', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8640, 1734, N'Dear Rosemary', N'4:26', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8641, 1734, N'Arlandria', N'4:27', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8642, 1735, N'Dictatosaurus', N'3:52', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8643, 1735, N'Centuries of Sin', N'4:09', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8644, 1735, N'Red War', N'3:30', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8645, 1735, N'Shake your Blood', N'2:59', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8646, 1735, N'Access Babylon', N'1:24', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8647, 1736, N'Awaken the Serpent', N'1:34', 0, CAST(0.00 AS Decimal(18, 2)))
;
INSERT `Tracks` (`Id`, `AlbumId`, `SongName`, `Length`, `Bytes`, `UnitPrice`) VALUES (8648, 1736, N'Rat Eater', N'1.55', 0, CAST(0.00 AS Decimal(18, 2)))
;
...
;
INSERT `Users` (`Id`, `Username`, `Password`, `Fullname`) VALUES (1, N'test', N'test', N'Test User')
;
INSERT `Users` (`Id`, `Username`, `Password`, `Fullname`) VALUES (2, N'rstrahl@west-wind.com', N'ww', N'Rick Strahl')
;
...
ALTER TABLE `Albums`  WITH CHECK ADD  CONSTRAINT FOREIGN KEY (`ArtistId`)
REFERENCES `Artists` (`Id`)
;
ALTER TABLE `Albums` CHECK CONSTRAINT `FK_dbo.Albums_dbo.Artists_ArtistId`
;
ALTER TABLE `Tracks`  WITH CHECK ADD  CONSTRAINT FOREIGN KEY (`AlbumId`)
REFERENCES `Albums` (`Id`)
;
ALTER TABLE `Tracks` CHECK CONSTRAINT `FK_dbo.Tracks_dbo.Albums_AlbumId`
;
